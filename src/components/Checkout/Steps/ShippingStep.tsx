...
import { AED, CheckoutFormValues, SHIPPING_OPTIONS } from "../Checkoutdata";
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col gap-1">
                      <div className="flex items-center gap-2">
                        ...
                        {option.badge && (
                          <span className="rounded-full bg-[#F97316] px-2 py-[2px] text-[10px] font-semibold text-white">
                            {option.badge}
                          </span>
                        )}
                      </div>
                      <p className="whitespace-pre-wrap text-[11px] text-[#6b7280]">
                        {option.description}
                      </p>
                    </div>
