    ...
    <>
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          onClick={onEdit}
          className="inline-flex cursor-pointer items-center gap-1 rounded-md border border-[#E5E7EB] bg-white hover:bg-[#eee] transition-all duration-300 px-3 py-1.5 text-xs font-medium text-[#374151] hover:bg-[#F9FAFB]"
        >
